...
- [x] 04-04-PLAN.md — Harden API init + legacy param backward compat (Gap closure) ✓
- [x] 04-05-PLAN.md — Virtual cursor position tracking for cu.cursorPosition (Gap closure) ✓
