...
- **v1.1 Distribution & Compatibility** — Phases 8-13 (shipped 2026-02-03) — [archive](milestones/v1.1-ROADMAP.md)
...
<details>
<summary>v1.1 Distribution & Compatibility (Phases 8-13) — SHIPPED 2026-02-03</summary>

- [x] Phase 8: CMake Multi-Qt Foundation (2/2 plans) — completed 2026-02-02
- [x] Phase 9: CI Matrix Build (1/1 plan) — completed 2026-02-02
- [x] Phase 10: Patched Qt 5.15.1 CI (2/2 plans) — completed 2026-02-02
- [x] Phase 11: Release Automation (2/2 plans) — completed 2026-02-02
- [x] Phase 11.1: Qt5/Qt6 Source Compatibility (2/2 plans) — completed 2026-02-02 (INSERTED)
- [x] Phase 12: vcpkg Port (2/2 plans) — completed 2026-02-03
- [x] Phase 13: PyPI Publication (2/2 plans) — completed 2026-02-03
