...
Also check if the `release.yml` workflow references qt6.2 artifacts and update those artifact names if so (artifact_tag qt6.2 → qt6.5). Similarly check `ci-patched-qt.yml` for any qt6.2 references.
  </action>
  <verify>
