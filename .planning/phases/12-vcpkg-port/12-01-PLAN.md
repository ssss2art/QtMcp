...
6. `vcpkg_cmake_config_fixup` uses `PACKAGE_NAME QtMCP` and `CONFIG_PATH share/cmake/QtMCP` (grep: `vcpkg_cmake_config_fixup(PACKAGE_NAME QtMCP CONFIG_PATH share/cmake/QtMCP)`)
  </verify>
