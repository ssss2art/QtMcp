...
void InputSimulator::mousePress(QWidget* widget, MouseButton button,
                                const QPoint& pos, Qt::KeyboardModifiers modifiers) {
    if (!widget) {
...
void InputSimulator::mouseRelease(QWidget* widget, MouseButton button,
                                  const QPoint& pos, Qt::KeyboardModifiers modifiers) {
    if (!widget) {
...
void InputSimulator::mouseMove(QWidget* widget, const QPoint& pos,
...
void InputSimulator::scroll(QWidget* widget, const QPoint& pos,
                            int dx, int dy, Qt::KeyboardModifiers modifiers) {
    if (!widget) {
...
void InputSimulator::mouseDrag(QWidget* window, const QPoint& startPos,
                               const QPoint& endPos, MouseButton button,
                               Qt::KeyboardModifiers modifiers) {
    if (!window) {
    ...
    QMouseEvent pressEvent(QEvent::MouseButtonPress,
                           QPointF(localStart), QPointF(globalStart),
                           qtButton, qtButton, modifiers);
    ...
    QMouseEvent moveEvent(QEvent::MouseMove,
                          QPointF(localEnd), QPointF(globalEnd),
                          Qt::NoButton, qtButton, modifiers);
