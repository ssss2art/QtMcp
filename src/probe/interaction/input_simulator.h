...
public:
    ...
    /// @param modifiers Keyboard modifiers
    static void mouseMove(QWidget* widget, const QPoint& pos,
    ...
    /// @param modifiers Keyboard modifiers
    static void scroll(QWidget* widget, const QPoint& pos = QPoint(),
                      int dx = 0, int dy = 0,
                      Qt::KeyboardModifiers modifiers = Qt::NoModifier);
    ...
    /// @param modifiers Keyboard modifiers
    static void mouseDrag(QWidget* window, const QPoint& startPos,
                         const QPoint& endPos,
