...
QJsonValue variantToJson(const QVariant& value)
{
    ...
    if (!strValue.isEmpty() && strValue != typeName) {
        return QJsonObject{
            {QStringLiteral("_type"), typeName},
            {QStringLiteral("value"), strValue}
        };
    }
...
QVariant jsonToVariant(const QJsonValue& value, int targetTypeId)
{
    ...
    case QMetaType::QPoint:
        if (value.isObject()) {
            QJsonObject obj = value.toObject();
            return QPoint(obj[QStringLiteral("x")].toInt(),
    ...
    case QMetaType::QPointF:
        if (value.isObject()) {
            QJsonObject obj = value.toObject();
            return QPointF(obj[QStringLiteral("x")].toDouble(),
    ...
    case QMetaType::QSize:
        if (value.isObject()) {
            QJsonObject obj = value.toObject();
            return QSize(obj[QStringLiteral("width")].toInt(),
    ...
    case QMetaType::QRect:
        if (value.isObject()) {
            QJsonObject obj = value.toObject();
            return QRect(obj[QStringLiteral("x")].toInt(),
                         obj[QStringLiteral("y")].toInt(),
    ...
    case QMetaType::QRectF:
        if (value.isObject()) {
            QJsonObject obj = value.toObject();
            return QRectF(obj[QStringLiteral("x")].toDouble(),
                          obj[QStringLiteral("y")].toDouble(),
    ...
    case QMetaType::QColor:
        if (value.isObject()) {
            QJsonObject obj = value.toObject();
            return QColor(obj[QStringLiteral("r")].toInt(),
                          obj[QStringLiteral("g")].toInt(),
